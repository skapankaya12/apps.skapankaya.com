 ...
 * NOTE: `name` is a placeholder pending final naming — change it here and it
 * updates across the whole site.
 */
export const brand = {
  name: "RunLocal", // TODO: final name pending (non-dev-friendly direction)
  domain: "runlocal.app",
  tagline: "Small tools, born from real problems.",
  description:
    "A marketplace for small software that solves one specific problem — built by the people who needed it. Buy it once, own it forever, run it on your own computer. Skip the bloated platform you use one feature of, and find the one tool that fixes your thing.",
  // Commission the platform keeps per sale (all-inclusive; see BUSINESS_MODEL.md)
  commissionRate: 0.15,
  supportEmail: "hello@runlocal.app",
  currency: "USD",
  currencySymbol: "$",
} as const;
